...
if(req.url.search('/wx/user/wxff3ba19a26d2069f')===-1){
		...
		{
			if(req.url.search('/wx/user/wxff3ba19a26d2069f/login')===-1){
				
				req.header.Authorization='wx '+uni.getStorageSync('token');
